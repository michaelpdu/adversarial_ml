...
class dna_to_pe:
    ...
    def make_new_pe(self,mal_sample_file, current_dna_dir, start_index,dna_size,pe_num):



        # set malicious content and new generated folder to adversary

        mal_file_name=self.set_malicious_file(mal_sample_file)
        ...
        dna_code_list=self.load_dna_files(current_dna_dir, start_index, dna_size)
        print('Generate new PE files ....')
        self.calc_binary_prediction(pop,mal_sample_file,dna_code_list,mal_file_name,new_generated_dir)
    ...
    def calc_binary_prediction(self,dna_array,mal_sample_file,dna_code_list,mal_file_name,new_generated_dir):
        ...
        for dna in dna_list:
            ...
            self.generate_new_pe(indexes,mal_sample_file,dna_code_list,mal_file_name,new_generated_dir)

    def generate_new_pe(self,index_list,mal_sample_file,dna_code_list,mal_file_name,new_generated_dir):
        try:
            modifier = PEModifier()
...
if __name__ == '__main__':
    ...
    if options.file_type:
        ...
        if options.file_type == 'PE':
            dtp=dna_to_pe()
            dtp.make_new_pe(options.file_path, options.dna_path,int(options.start_index),int(options.step),int(options.pe_num))
    else:
        print(help_msg)
